...
* **What went wrong:** The fixed stop-loss worked perfectly for stable stocks like `AAPL` but caused a severe **"whipsaw" effect** on `TSLA` and Bitcoin. It forcefully exited positions during normal daily fluctuations, actively destroying performance compared to buy-and-hold.
